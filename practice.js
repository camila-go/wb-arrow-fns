...
const outerFn = (callback) => callback();
...
// Invoking outerFn and passing innerFn as the callback
 outerFn(innerFn); // This will print "The innerFn is a callback!" to the console.
...
// Invoking fullName with first name, last name, and welcomeMessage as arguments
console.log(fullName("Camila", "Gonzalez", welcomeMessage));// This will print "Welcome to DevMountain, John Doe!" to the console.
...
// Invoking canDrink with age, drinkSoda, and drinkAlcohol as arguments
// This will output "Come back when you are legally allowed a drink!" or "Drink responsibly!"
console.log(canDrink(age, drinkSoda, drinkAlcohol));
...
// Example usage:
console.log(math(2, 3, add)); // Output: 5
console.log(math(2, 3, multiply)); // Output: 6
...
const taxRate = 0.07;
let postTaxPrices = prices.map(price => price * (1 + taxRate));

console.log(postTaxPrices);
// Output: [16.05, 24.61, 83.46, 36.38, 12.84, 91.82, 12.84, 84.53, 34.24]
...
let totalPopulation = populations.reduce((runningTotal, curElement) => runningTotal + curElement, 0);
